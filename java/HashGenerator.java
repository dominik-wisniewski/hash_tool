...
public class HashGenerator {
	...
	public static String generateBcrypt(String password, String salt, int costFactor) {

		byte[] pass_arr = password.getBytes();
		byte[] salt_arr = salt.getBytes();
		byte[] hash = BCrypt.generate(pass_arr, salt_arr, costFactor);
